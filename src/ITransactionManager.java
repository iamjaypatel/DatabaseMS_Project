...
public interface ITransactionManager {
     ...
     * <p>Notes:
     * <ul>
     * <li> Examples of failures: not having enough points to redeem coffees, certain coffee not being sold in the store, etc.</li>
     * </ul>
     * </p>
     */
     ...
     * <p>Notes:
     * <ul>
     * <li> Revenue is defined as the sum of money that the customers pay for the coffees</li>
     * <li> 1 month is defined as 30 days counting back starting from the current date time</li>
     * <li> The returned list should be sorted, with the ID of the store with the highest revenue at its head</li>
     * <li> If multiple stores have the same revenue in the kth highest revenue position, their ID's should all be returned.</li>
     * <li> It returns an empty list if no store is in the database or the operation failed</li>
     * </ul>
     * </p>
     */
     ...
     * <ul>
     * <li> 1 month is defined as 30 days counting back starting from the current date time</li>
     * <li> The returned list should be sorted, with the ID of the customer with the highest spending at its head</li>
     * <li> If multiple customers have the same spending in the kth highest revenue position, their ID's should all be returned.</li>
     * <li> It returns an empty list if no customer is in the database or the operation failed</li>
     * </ul>
     * </p>
     */
